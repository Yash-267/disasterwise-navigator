...
const ChatAssistant: React.FC = () => {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      } else if (input.toLowerCase().includes('hurricane') || input.toLowerCase().includes('cyclone') || input.toLowerCase().includes('storm')) {
      ...
      } else if (input.toLowerCase().includes('landslide')) {
      ...
      } else if (input.toLowerCase().includes('evacuation') || input.toLowerCase().includes('evacuate')) {
      ...
      } else if (input.toLowerCase().includes('hospital') || input.toLowerCase().includes('medical') || input.toLowerCase().includes('injured')) {
      ...
      } else if (input.toLowerCase().includes('shelter') || input.toLowerCase().includes('relief camp')) {
      ...
      } else if (input.toLowerCase().includes('help') || input.toLowerCase().includes('emergency')) {
